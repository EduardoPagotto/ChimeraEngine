...
void Cube::addFace(bool clockwise, int numFace, int numTex, std::vector<Chimera::VertexData>& vl, std::vector<Core::Triangle>& tl) {
    ...
    Core::Triangle t1 = Core::Triangle(ia, ib, ic, glm::vec3(0.0f));
    t1.calcNormal(vl);
    tl.push_back(t1);
}
...
void Cube::newWall(std::vector<Chimera::VertexData>& vl, std::vector<Core::Triangle>& tl) {
...
void Cube::newRamp(bool isFloor, CARDINAL card, std::vector<Chimera::VertexData>& vl, std::vector<Core::Triangle>& tl) {
...
void Cube::newDiag(std::vector<Chimera::VertexData>& vl, std::vector<Core::Triangle>& tl) {
...
void Cube::newFloor(std::vector<Chimera::VertexData>& vl, std::vector<Core::Triangle>& tl) {
...
void Cube::newCeeling(std::vector<Chimera::VertexData>& vl, std::vector<Core::Triangle>& tl) {
...
void Cube::newFlatFloorCeeling(bool isFloor, CARDINAL card, std::vector<Chimera::VertexData>& vl, std::vector<Core::Triangle>& tl) {
...
void Cube::newRampNSEW(SPACE space, std::vector<Chimera::VertexData>& vl, std::vector<Core::Triangle>& tl) {
...
void Cube::create(std::vector<Chimera::VertexData>& vl, std::vector<Core::Triangle>& tl) {
