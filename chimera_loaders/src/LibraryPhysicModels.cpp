    ...
    for(l_nPhyModel; l_nPhyModel; l_nPhyModel=l_nPhyModel->NextSiblingElement()) {
        ...
        if (url.compare(l_id) == 0) {
            ...
            for(l_nRigid; l_nRigid; l_nRigid=l_nRigid->NextSiblingElement()) {
                ...
                tinyxml2::XMLElement* l_npm = l_nRigid->FirstChildElement ("technique_common")->FirstChildElement ( "instance_physics_material" );
                if ( l_npm != nullptr ) {
...
void LibraryPhysicModels::loadColladaShape ( tinyxml2::XMLElement* _root, tinyxml2::XMLElement* _nShape, Chimera::Solid *_pPhysic) {
    ...
    if ( strcmp ( l_tipoShape, "sphere" ) == 0 ) {
        ...
        if ( l_arrayValores.size() == 1 ) {
            ...
            throw Chimera::ExceptionChimera(Chimera::ExceptionCode::READ, "Shape Sphere Array valores invalidos: " + url);
        }
        ...
        if ( l_arrayValores.size() == 1 ) {
            ...
            throw Chimera::ExceptionChimera(Chimera::ExceptionCode::READ, "Shape Plane Array valores invalidos: " + url);
        }
        ...
        if ( l_arrayValores.size() == 1 ) {
            ...
            throw Chimera::ExceptionChimera(Chimera::ExceptionCode::READ, "Shape Box Array valores invalidos: " + url);
        }
        ...
        if ( l_arrayValores.size() == 1 ) {
            ...
            throw Chimera::ExceptionChimera(Chimera::ExceptionCode::READ, "Shape Cylinder Array valores invalidos: " + url);
        }
