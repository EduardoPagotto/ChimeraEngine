...
class ShadowPass {
  public:
    ...
    virtual ~ShadowPass();
    void exec(Registry* registry, Camera* camera, EyeView* eyeView, IRenderer3d& renderer, ITrans* origem, const bool& logRender);
    void appy(Camera* camera, IRenderer3d& renderer);
