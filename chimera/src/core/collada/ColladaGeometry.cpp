...
void ColladaGeometry::create(Entity& entity, pugi::xml_node geo) {
    ...
    if (pugi::xml_node mesh = geo.child("mesh"); mesh != nullptr) {
        ColladaMesh cf(m_colladaDom, "#vazio");
