...
Solid::Solid(PhysicsControl* _pWorld, const glm::mat4& _trans, uint32_t entity)
    : pWorld(_pWorld), pRigidBody(nullptr), pShapeCollision(nullptr), trimesh(nullptr), mass(0.0f),
      frictionDynamic(15.0f), frictionStatic(10.0f), restitution(0.0f), entity(entity) {
