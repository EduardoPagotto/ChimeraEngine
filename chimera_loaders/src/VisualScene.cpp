...
VisualScene::VisualScene(const std::string& _file, Chimera::Group* _pGroup)
...
void VisualScene::target() {
    tinyxml2::XMLElement* l_nVisual =
        root->FirstChildElement("scene")->FirstChildElement("instance_visual_scene");
    if (l_nVisual) {
