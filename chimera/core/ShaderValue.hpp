...
class ShaderValue4vf : public ShaderValue {
  public:
    ...
    virtual inline void apply(Shader* _shader) override { _shader->setUniform4fv(name.c_str(), 1, (float*)&value[0]); }
...
class ShaderValue1vf : public ShaderValue {
  public:
    ...
    virtual inline void apply(Shader* _shader) override { _shader->setUniform1fv(name.c_str(), 1, (float*)&value); }
...
class ShaderValue1i : public ShaderValue {
  public:
    ...
    virtual inline void apply(Shader* _shader) override { _shader->setUniform1i(name.c_str(), value); }
