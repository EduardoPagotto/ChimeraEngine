...
TileLayer::TileLayer(std::shared_ptr<Chimera::Shader> shader)
    : Chimera::Layer(new Chimera::BatchRender2D(), shader, new Chimera::CameraOrtho(16.0, 16.0, -1.0f, 1.0f), "TileLayer") {
