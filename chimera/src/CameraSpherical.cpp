...
CameraSpherical::CameraSpherical ( const CameraSpherical& _cameraSpherical ) : Camera ( _cameraSpherical ) {
    ...
    along = _cameraSpherical.along;
    up = _cameraSpherical.up;
    forward = _cameraSpherical.forward;
...
void CameraSpherical::updateTrack() {
...
void CameraSpherical::yaw ( GLfloat _theta ) {
...
void CameraSpherical::pitch ( GLfloat _theta ) {
...
void CameraSpherical::roll ( GLfloat _theta ) {
...
void CameraSpherical::walk ( GLfloat _delta, bool _wall[4] ) {
...
void CameraSpherical::strafe ( GLfloat _delta, bool _wall[4] ) {
...
void CameraSpherical::fly ( GLfloat _delta, bool _wall[4] ) {
