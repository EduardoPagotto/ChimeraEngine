...
#ifdef WIN32
            Texture *pTex = new Texture(l_id, _textureDir+ "\\" + l_val, 0); //FIXME quando outras texturas presentes 0 difuse, 1 specula, 2 emissive
#else
            Texture *pTex = new Texture(l_id, _textureDir+ "/" + l_val, 0);
#endif
